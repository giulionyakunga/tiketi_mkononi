...
class EventCard2 extends StatelessWidget {
  ...
  const EventCard2({super.key, required this.event, required this.userId, required this.role, required this.refreshMethod, required this.useDNS});
  ...
  Widget build(BuildContext context) {
    ...
    final mainTicketType = event.ticketTypes.isNotEmpty ? event.ticketTypes.first : null;
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      formatNumber(mainTicketType.soldTickets),
                                      style: TextStyle(
                                        fontSize: 10,
                                        fontWeight: FontWeight.bold,
